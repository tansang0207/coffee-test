...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: X6N1m0i3iM_P/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__ulh9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__e0AfS)}
              role={"img"}
            />
          ),
